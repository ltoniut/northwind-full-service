...
const Employee_1 = require("northwind-rest-commons/dist/typeorm/entities/Employee");
const typeorm_2 = require("northwind-rest-commons/node_modules/typeorm");
let EmployeeRepositoryImpl = class EmployeeRepositoryImpl extends repository_typeorm_1.TypeORMRepository {
    constructor(manager) {
        super(Employee_1.Employee, [], [], manager, {});
    }
};
