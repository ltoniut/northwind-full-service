...
let OrderControllerImpl = class OrderControllerImpl extends controller_impl_1.BaseControllerImpl {
    constructor(service) {
        super(service, controllerPath);
    }
};
OrderControllerImpl = __decorate([
    swagger_1.ApiTags(controllerPath),
    common_1.Controller(controllerPath),
    __param(0, common_1.Inject(interfaces_1.OrderServiceKey)),
